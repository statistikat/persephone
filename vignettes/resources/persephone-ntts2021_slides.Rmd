...
```{r , echo=FALSE, fig.cap="https://xkcd.com/1319/", out.width = '65%'}
...
```
* Now different methods can be called for the persephone object `objX13`, most importantly the `run()` method
...
## Persephone Hierarchical Object - Weights
