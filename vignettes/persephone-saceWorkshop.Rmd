...
For all countries’ time series we want to generate persephone objects with x13 as method.
...
# hts_EU28 <- per_hts(list = c(EA19=hts_EA19,ts_28[non_EA19]), weights = c(??,w_non_EA19))
```
